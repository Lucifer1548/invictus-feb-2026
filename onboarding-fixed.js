...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeEventListeners() {
        ...
        // Preference toggles with better event handling
        ['morningMeditation', 'yogaBreak', 'eyeExercises', 'eveningWindDown'].forEach(id => {
            ...
            if (checkbox) {
                ...
                // Initialize toggle slider color
        ...
        // Step 4: Permissions with enhanced event handling
        ['cameraPermission', 'calendarPermission', 'notificationPermission'].forEach(id => {
            ...
            if (checkbox) {
                checkbox.addEventListener('change', function() {
                    ...
                    if (permissionCard) {
                        if (this.checked) {
                            permissionCard.style.borderColor = 'var(--accent-saffron)';
                            permissionCard.style.background = 'rgba(212, 168, 83, 0.05)';
                        } else {
                            permissionCard.style.borderColor = 'var(--border-subtle)';
                            permissionCard.style.background = 'var(--bg-secondary)';
                        }
                    }
                });
                ...
                // Initialize permission card state
    ...
    console.log('KEDAR onboarding initialized successfully');
});
